...
<nav class="navbar navbar-expand-lg bg-dark navbar-dark">
    <div class="container-fluid">
        ...
        <a class="navbar-brand ms-2 fs-3 text-white bold" href="/">EcoFertil</a>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-3 text-center text-md-start">
                <img src="{{ asset('Imagenes/Logo SM.png') }}" alt="Logo" class="rounded-circle" style="width: 125px; height: 125px;">
            </div>
            <div class="col-md-6 text-center">
                <p class="mb-1">&copy; 2025 EcoFertil. Todos los derechos reservados.</p>
                <p class="mb-1">Creado por: </p>
